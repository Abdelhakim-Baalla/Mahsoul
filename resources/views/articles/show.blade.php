...
<div class="bg-gradient-to-r from-green-600 to-green-800 py-8">
    <div class="container mx-auto px-4">
        <div class="flex items-center gap-2 text-white mb-4">
            ...
            <a href="{{ url('articles/tag/irrigation') }}" class="hover:underline">Irrigation</a>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
            <span>Techniques d'irrigation modernes</span>
        </div>
        <h1 class="text-3xl font-bold text-white">Techniques d'irrigation modernes pour économiser l'eau</h1>
    </div>
</div>
    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="lg:w-2/3">
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <!-- Image principale -->
                <img src="https://via.placeholder.com/1200x600" alt="Techniques d'irrigation modernes" class="w-full h-80 object-cover">
                
                <!-- Métadonnées de l'article -->
                <div class="p-6">
                    <div class="flex flex-wrap items-center gap-4 mb-6 text-sm text-gray-600">
                        <div class="flex items-center">
                            <img src="https://via.placeholder.com/40x40" alt="Ahmed Benali" class="w-10 h-10 rounded-full mr-2">
                            <span>Par <a href="#" class="text-green-600 hover:underline">Ahmed Benali</a></span>
                        </div>
                        <div class="flex items-center">
                            ...
                            <span>Publié le 15 juin 2023</span>
                        </div>
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="flex flex-wrap gap-2 mb-6">
                        <a href="{{ url('articles/tag/irrigation') }}" class="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm hover:bg-blue-200 transition">Irrigation</a>
                    ...
                    <div class="prose max-w-none">
                        ...
                        <h2>Pourquoi économiser l'eau est crucial</h2>
                        ...
                        <h2>Les techniques d'irrigation goutte-à-goutte</h2>
                        ...
                        <div class="my-6">
                            ...
                            <p class="text-sm text-gray-600 mt-2">Système d'irrigation goutte-à-goutte installé dans un champ de tomates</p>
                        </div>
                        ...
                        <h2>L'irrigation par aspersion contrôlée</h2>
                        ...
                        <div class="my-6">
                            ...
                            <p class="text-sm text-gray-600 mt-2">Système d'irrigation par aspersion avec contrôle informatisé</p>
                        </div>
                        
                        <h2>L'irrigation intelligente basée sur les données</h2>
                        ...
                        <h2>Étude de cas : Ferme El Baraka</h2>
                        ...
                        <blockquote>
                            ...
                            <cite>— Mohammed Kadiri, propriétaire de la ferme El Baraka</cite>
                        </blockquote>
                        
                        <h2>Comment démarrer avec l'irrigation moderne</h2>
                    ...
                    <div class="mt-8 border-t pt-6">
                        ...
                        <div class="flex gap-3">
                            ...
                            <a href="#" class="bg-green-600 text-white p-2 rounded-full hover:bg-green-700">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="#" class="bg-gray-700 text-white p-2 rounded-full hover:bg-gray-800">
                    ...
                    <div class="mt-10 border-t pt-8">
                        ...
                        <div class="mb-8">
                            ...
                            <form>
                                <div class="mb-4">
                                    <textarea rows="4" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="Votre commentaire..."></textarea>
                                </div>
                                <div class="flex justify-end">
                                    <button type="submit" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition">Publier le commentaire</button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="space-y-6">
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="mt-2 flex items-center gap-4">
                                            <button class="text-sm text-gray-600 hover:text-green-600 flex items-center gap-1">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 20m7-10V5a2 2 0 00-2-2h-.095c-.5 0-.905.405-.905.905 0 .714-.211 1.412-.608 2.006L7 11v9m7-10h-2M7 20H5a2 2 0 01-2-2v-6a2 2 0 012-2h2.5" />
                                                </svg>
                                                12
                                            </button>
                                            <button class="text-sm text-gray-600 hover:text-green-600">Répondre</button>
                                        </div>
                                    </div>
                                </div>
                                
                                <!-- Réponse au commentaire -->
                                <div class="ml-12 mt-4 border-l-2 border-gray-200 pl-4">
                                    <div class="flex items-start gap-3">
                                        <img src="https://via.placeholder.com/40x40" alt="Auteur" class="w-8 h-8 rounded-full">
                                        <div>
                                            <div class="flex items-center gap-2 mb-1">
                                                <h5 class="font-medium">Ahmed Benali</h5>
                                                <span class="bg-green-100 text-green-800 text-xs px-2 py-0.5 rounded">Auteur</span>
                            ...
                            <button class="w-full py-2 text-center text-green-600 hover:text-green-800 font-medium">
                                Voir plus de commentaires
                            </button>
                        </div>
                    </div>
        ...
        <div class="lg:w-1/3">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <a href="#" class="text-green-600 hover:text-green-800 font-medium">Voir tous ses articles</a>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div class="space-y-4">
                    <div class="flex gap-3">
                        <img src="https://via.placeholder.com/100x100" alt="Article" class="w-20 h-20 object-cover rounded">
                        <div>
                            <h4 class="font-medium leading-tight"><a href="#" class="hover:text-green-600">Récupération des eaux de pluie pour l'agriculture</a></h4>
                    ...
                    <div class="flex gap-3">
                        <img src="https://via.placeholder.com/100x100" alt="Article" class="w-20 h-20 object-cover rounded">
                        <div>
                            <h4 class="font-medium leading-tight"><a href="#" class="hover:text-green-600">Sélection des cultures adaptées aux climats arides</a></h4>
                    ...
                    <div class="flex gap-3">
                        <img src="https://via.placeholder.com/100x100" alt="Article" class="w-20 h-20 object-cover rounded">
                        <div>
                            <h4 class="font-medium leading-tight"><a href="#" class="hover:text-green-600">Subventions disponibles pour les systèmes d'irrigation modernes</a></h4>
                            <p class="text-sm text-gray-600 mt-1">Il y a 1 mois</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <a href="{{ url('articles/tag/economie-eau') }}" class="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm hover:bg-green-200 transition">Économie d'eau</a>
                    <a href="{{ url('articles/tag/techniques') }}" class="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm hover:bg-green-200 transition">Techniques agricoles</a>
                    <a href="{{ url('articles/tag/elevage') }}" class="px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm hover:bg-purple-200 transition">Élevage</a>
                    <a href="{{ url('articles/tag/maladies') }}" class="px-3 py-1 bg-red-100 text-red-800 rounded-full text-sm hover:bg-red-200 transition">Maladies des plantes</a>
                    <a href="{{ url('articles/tag/semences') }}" class="px-3 py-1 bg-yellow-100 text-yellow-800 rounded-full text-sm hover:bg-yellow-200 transition">Semences</a>
                </div>
            </div>
            ...
            <div class="bg-green-50 rounded-lg shadow-md p-6">
                ...
                <form>
                    <div class="mb-3">
                        <input type="email" placeholder="Votre adresse email" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
                    </div>
                    <button type="submit" class="w-full py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition">S'abonner</button>
                </form>
            </div>
        </div>
    </div>
