                        ...
                        <form action="/profile/update" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-5">
                                        <div class="relative">
                                            <label for="photo" class="bg-primary-600 hover:bg-primary-700 text-white py-2 px-4 rounded-md font-medium cursor-pointer transition duration-150 ease-in-out inline-block">
                            ...
                            <div class="mb-6">
                                ...
                                <textarea id="adresse" name="adresse" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500" required>{{ Auth::user()->adresse }}</textarea>
                            </div>
