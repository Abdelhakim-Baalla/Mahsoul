                                ...
                                <div class="p-6">
                                    <form action="/agricole/information/update" method="POST">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                            <!-- Nom de la Ferme -->
                                            <div>
                                                <label for="ferme" class="block text-sm font-medium text-gray-700 mb-1">Nom de la Ferme</label>
                                                <input type="text" id="ferme" name="ferme" value="{{ Auth::user()->agricole->ferme ?? '' }}"
                                                    class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500">
                                            </div>

                                            <!-- Type des Produits -->
                                            <div>
                                                <label for="produit" class="block text-sm font-medium text-gray-700 mb-1">Type des Produits</label>
                                                <input type="text" id="produit" name="produit" value="{{ Auth::user()->agricole->produit ?? '' }}"
                                                    class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500">
                                            </div>

                                            <!-- Superficie -->
                                            <div>
                                                <label for="superficie" class="block text-sm font-medium text-gray-700 mb-1">Superficie (ha)</label>
                                                <input type="text" step="0.01" id="superficie" name="superficie_terrain"
                                                    value="{{ Auth::user()->agricole->superficie_terrain ?? '' }}"
                                                    class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500">
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <input type="text" id="region" name="region" value="{{ Auth::user()->agricole->region ?? '' }}"
                                                    class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500">
                                            </div>
                                        </div>

                                        <!-- Champ caché pour l'ID agricole -->
                                        @if(Auth::user()->agricole)
                                        <input type="hidden" name="agricole_id" value="{{ Auth::user()->agricole->id }}">
                                        @endif
