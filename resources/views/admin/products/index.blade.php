                        ...
                        <tr class="hover:bg-green-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                ...
                                <form action="{{ route('products.show') }}" method="POST">
                                    ...
                                    <button type="submit" class="text-green-600 hover:text-green-900" title="Voir le produit">
                                ...
                                <form action="{{ route('admin.products.edit') }}" method="POST">
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $produit->id }}">
                                    <button type="submit" class="text-blue-600 hover:text-blue-900" title="Modifier">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
