...
<div class="min-h-screen bg-primary-50 py-12">
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        <!-- Login Card - Même style que registration -->
        <div class="rounded-lg shadow-lg overflow-hidden bg-white">
            ...
            <div class="flex flex-col md:flex-row">
                <!-- Image Section - Identique à register -->
                <div class="md:w-2/5 lg:w-1/2 relative h-64 md:h-auto">
                    <img src="{{ asset('images/login-pages-header.jpg') }}" 
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="email" id="email" name="email" value="{{ old('email') }}" 
                                       class="w-full pl-10 px-4 py-2 border {{ $errors->has('errorLogin') ? 'border-red-500' : 'border-gray-300' }} rounded-md focus:ring-primary-500 focus:border-primary-500" 
                                       required>
                            </div>
                        </div>
