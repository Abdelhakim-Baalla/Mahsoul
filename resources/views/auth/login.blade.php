...
@section('content')
    <div class="min-h-screen bg-primary-50 py-12">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8"> <!-- Conteneur plus large -->
            
            <!-- Login Card -->
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                <div class="md:flex">
                    <!-- Left Side - Image (plus large) -->
                    <div class="hidden md:block md:w-2/5 lg:w-1/2 relative h-64 md:h-auto">
                        <img src="{{ asset('images/pattern-leaves.jpg') }}" 
                             alt="Connexion Mahsoul" 
                    ...
                    <div class="md:w-3/5 lg:w-1/2 p-8 md:p-10">
                        ...
                        <div class="flex justify-center mb-8">
                            <span class="text-2xl font-bold text-primary-700">Mahsoul</span>
                        </div>
