function validateTagEditForm() {
    ...
    var nomTag = document.getElementById('edit-nom');
    ...
    var longueur = nomTag.value.trim().length;
    if (longueur < 3) {
        return marquerErreur(nomTag, "Le nom du tag doit contenir au moins 3 caractères");
    }
    if (longueur > 50) {
        return marquerErreur(nomTag, "Le nom du tag ne peut pas dépasser 50 caractères");
    }
